...
NSString *const MJRefreshFooterReleaseToRefresh = @"放手刷新, 放手去爱";
NSString *const MJRefreshFooterRefreshing = @"奋力加载, 奋力生活";

NSString *const MJRefreshHeaderPullToRefresh = @"下拉刷新";
NSString *const MJRefreshHeaderReleaseToRefresh = @"放手刷新, 放手去爱";
NSString *const MJRefreshHeaderRefreshing = @"奋力加载, 奋力生活";
